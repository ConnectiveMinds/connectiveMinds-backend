...
export const sendOTPMail = ({ to, otp }: { to: string; otp: number }) => {
  new Promise((resolve, reject) => {
    const mailOptions = {
      from: "ConnectiveMinds",
      to: to,
      subject: "OTP",
      html: `<!doctype html>
        <!doctype html>
                        ...
                        <table style="background-color: #f2f3f8; max-width:670px;  margin:0 auto;" width="100%" border="0"
                            ...
                            <tr>
                                <td style="text-align:center;">
                                    ...
                                    <img width="60" src="https://i.postimg.cc/kgDK04HY/6c7c577a899ef25d06c0217bf8275cbc.png" title="logo" alt="logo">
                                  </a>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="text-align:center;">
                                    <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">&copy; <strong>ConnectiveMinds</strong></p>
                                </td>
                            </tr>
                            <tr>
                                <td style="height:80px;">&nbsp;</td>
